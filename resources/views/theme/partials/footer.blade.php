<footer class="footer-area section-padding">
    ...
    <div class="row">
        ...
        <div class="single-footer-widget">
            ...
            <form  action="{{ route('subscriber.store2') }}"
                method="post" class="form-inline">
                @csrf

                    <div class="d-flex flex-row">
                        <input class="form-control" name="mail" placeholder="Enter Email" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Email '"
                        value="{{ old('mail') }}" ">
